...
class _DataPokokState extends State<DataPokok> {
  ...
  void initState() {
    ...
    super.initState();
    fetch("1", _pageData.toString(), null, null, null);
    fetchKategori("1");
    fetchfile("1", "");
    fetchListTahun("1");
    fetchListTahunFile("1");
    fetchListSumberData("1");
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        fetch("1", _pageData.toString(), _tahun, _sumber_data, _semester);
      }
    });
  }
                    ...
                    children: <Widget>[
                      FlatButton.icon(
                        ...
                        onPressed: () {
                          ...
                          fetch("1", 0.toString(), _tahun, _sumber_data,
                              _semester);
