              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  var hasilsearchsubket1 = snapshot.data
                      .where((a) => a.subket1.toLowerCase().contains(query));
                  ...
                  return Column(
                    children: hasilsearch
                        ...
                        .toList().getRange(0, query.length<9?(hasilsearch.length<apiprovider.limit?hasilsearch.length:apiprovider.limit):hasilsearch.length).toList(),
                  );
